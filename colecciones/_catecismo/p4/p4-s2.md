...
[**2826**](#n2826) Por la oración, podemos «discernir cuál es la voluntad de Dios» (Rm [12, 2]({{ "biblia-straubinger/romanos#c12-v2" | relative_url }}); Ef [5, 17]({{ "biblia-straubinger/efesios#c5-v17" | relative_url }})) y obtener «constancia para cumplirla» (Hb 10, 36). Jesús nos enseña que se entra en el Reino de los cielos, no mediante palabras, sino «haciendo la voluntad de mi Padre que está en los cielos» (Mt 7, 21).
{:#n2826}
