...
[**1590**](#n1590) *San Pablo dice a su discípulo Timoteo: "Te recomiendo que reavives el carisma de Dios que está en ti por la imposición de mis manos" (2 Tm [1, 6]({{ "biblia-straubinger/2-timoteo#c1-v6" | relative_url }})), y "si alguno aspira al cargo de obispo, desea una noble función" (1 Tm 3,1). A Tito decía: "El motivo de haberte dejado en Creta, fue para que acabaras de organizar lo que faltaba y establecieras presbíteros en cada ciudad, como yo te ordené" (Tt [1, 5]({{ "biblia-straubinger/tito#c1-v5" | relative_url }}))*.
{:#n1590}
