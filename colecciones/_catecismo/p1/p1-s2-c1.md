...
[**381**](#n381) *El hombre es predestinado a reproducir la imagen del Hijo de Dios hecho hombre —«imagen del Dios invisible» (Col [1, 15]({{ "biblia-straubinger/colosenses#c1-v15" | relative_url }}))—, para que Cristo sea el primogénito de una multitud de hermanos y de hermanas (cf. Ef 1,3-6; Rm [8, 29]({{ "biblia-straubinger/romanos#c8-v29" | relative_url }}))*.
{:#n381}
