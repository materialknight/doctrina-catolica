...
[**757**](#n757) «La Iglesia que es llamada también "la Jerusalén de arriba" y "madre nuestra" (Ga 4, 26; cf. Ap 12, 17), y se la describe como la esposa inmaculada del Cordero inmaculado (Ap 19, 7; 21, 2. 9; 22, 17). Cristo "la amó y se entregó por ella para santificarla" (Ef [5, 25]({{ "biblia-straubinger/efesios#c5-v25" | relative_url }})-26); se unió a ella en alianza indisoluble, "la alimenta y la cuida" (Ef [5, 29]({{ "biblia-straubinger/efesios#c5-v29" | relative_url }})) sin cesar». (LG 6)
{:#n757}
...
— «Su *ley*, es el mandamiento nuevo: amar como el mismo Cristo mismo nos amó (cf. Jn 13, 34)». Esta es la ley «nueva» del Espíritu Santo (Rm [8, 2]({{ "biblia-straubinger/romanos#c8-v2" | relative_url }}); Ga 5, 25).
...
— fue y permanece edificada sobre «el fundamento de los Apóstoles» (Ef [2, 20]({{ "biblia-straubinger/efesios#c2-v20" | relative_url }}); Hch 21, 14), testigos escogidos y enviados en misión por el mismo Cristo (cf. Mt 28, 16-20; Hch 1, 8; 1 Co [9, 1]({{ "biblia-straubinger/1-corintios#c9-v1" | relative_url }}); [15, 7]({{ "biblia-straubinger/1-corintios#c15-v7" | relative_url }})-8; Ga 1, 1; etc.).
